...
在U盘上运行 HMCL 的绝佳方案\
[English](README.md) 简体中文 [文档](https://bugteas.github.io/item.html?proFile=1919810/HHMLDocs/en.js)\
最新版本：3.5.3.229 Update 1
## HHML 介绍
...
此外 HHML 脚本还能使得 HMCL 启动器检测当前目录下的Java并自动选择，无需安装或手动添加。
## 简单用法
...
配置名：verBlackList\
用法：将你不想使用的版本的版本号（可以多个,每个版本间用英符逗号隔开）写入参数中，在检测版本时会将与其对应的版本屏蔽掉。\
默认参数：none\
参数示例：
```
