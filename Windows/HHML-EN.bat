...
set txt004=Unable to get the version nunber of HMCL,
set txt005=will be used, version number is
set txt006= ^(Converted to an integer^).
set txt007=will be launched as the latest version by default in file order.
...
set txt202=HMCL will be launched through
set txt203=
set txt301=
set txt302=, path is
...
set txt506=Please configure the ^"use64java^" parameter to 0 or 1 in ^"config.txt^" file according to the Java bit width ^^(32bit/64bit^^).
...
set txt705=Backing up global config file for next boot
...
set txt107=Version 
set txt108= is in the black list, HMCL will not be launched through it.
...
set txt801=The program crash unexpectedly.
set txt802=Detected HMCL: 
